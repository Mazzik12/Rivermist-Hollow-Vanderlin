/datum/job/mason
	...
	You lay roads, raise walls, mend foundations, and carve stone meant to outlast generations. \
	Long after banners fade and rulers change, your work remains — steady, solid, and trusted."
